      ...
      <header className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-4xl px-6 py-24 text-center">
          <motion.div
            ...
            <p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground">The exclusive skill exchange platform for SRM AP University students. Teach Python, learn Canva - find your perfect learning partner on campus.
